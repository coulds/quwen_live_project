...
public class BankCardAdapter extends RecyclerView.Adapter<BankCardAdapter.BankCardViewHolder> {
   ...
   ArrayList<BankCard> bankCards;
    public BankCardAdapter(Context context,List<BankCard> bankCards) {
        ...
        this.bankCards= (ArrayList<BankCard>) bankCards;
    }
    ...
    public void onBindViewHolder(@NonNull BankCardViewHolder holder, int position) {
           ...
           holder.tv_bankAccount.setText(bankCard.getBankAccount());
           holder.tv_bankCardNumber.setText(bankCard.getBankCardNumber());
    }
