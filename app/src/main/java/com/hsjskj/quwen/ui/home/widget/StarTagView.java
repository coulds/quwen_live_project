...
public class StarTagView extends FrameLayout {
    ...
    public void setTagText(String s, boolean isMale) {
        if (tv_item_constellation != null) {
            tv_item_constellation.setText(s);

            if (isMale) {
                Drawable drawable = getResources().getDrawable(R.drawable.home_sex_male, getContext().getTheme());
                ...
                Drawable drawable = getResources().getDrawable(R.drawable.home_sex_female, getContext().getTheme());
                drawable.setBounds(0, 0, UiUtlis.dp2px(getContext(), 12), UiUtlis.dp2px(getContext(), 12));
